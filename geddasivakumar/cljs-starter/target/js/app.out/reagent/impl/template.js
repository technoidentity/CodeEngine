...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5504__auto__,writer__5505__auto__,opt__5506__auto__){
return cljs.core._write.call(null,writer__5505__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4906__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4906__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4906__auto__)){
return or__4906__auto__;
} else {
...
var G__17022 = o;
(G__17022[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__17023__delegate = function (args){
...
return G__17023__delegate.call(this,args);};
G__17023.cljs$lang$maxFixedArity = 0;
G__17023.cljs$lang$applyTo = (function (arglist__17025){
var args = cljs.core.seq(arglist__17025);
return G__17023__delegate(args);
});
...
var old_17026 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_17026))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_17026)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__4894__auto__ = (node === document.activeElement);
if(and__4894__auto__){
var and__4894__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__4894__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__17029 = jsprops;
(G__17029["defaultValue"] = value);

(G__17029["onChange"] = ((function (G__17029,v,value,on_change){
return (function (p1__17027_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17027_SHARP_);
});})(G__17029,v,value,on_change))
);
...
var vec__17031 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17031,(0),null);
var id = cljs.core.nth.call(null,vec__17031,(1),null);
var class$ = cljs.core.nth.call(null,vec__17031,(2),null);
...
var temp__4427__auto__ = (function (){var G__17035 = cljs.core.meta.call(null,v);
var G__17035__$1 = (((G__17035 == null))?null:reagent.impl.template.get_key.call(null,G__17035));
return G__17035__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__17037_17038 = v;
var G__17037_17039__$1 = (((G__17037_17038 == null))?null:reagent.impl.template.key_from_vec.call(null,G__17037_17038));
var G__17037_17040__$2 = (((G__17037_17039__$1 == null))?null:(jsprops["key"] = G__17037_17039__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__17043 = cljs.core.meta.call(null,argv);
var G__17043__$1 = (((G__17043 == null))?null:reagent.impl.template.get_key.call(null,G__17043));
return G__17043__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__17044 = (((jsprops == null))?{}:jsprops);
(G__17044["key"] = key);
...
var G__17045 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__17045;
continue;
}
} else {
...
var n__5809__auto___17046 = a.length;
var i_17047 = (0);
while(true){
if((i_17047 < n__5809__auto___17046)){
(a[i_17047] = reagent.impl.template.as_element.call(null,(a[i_17047])));

var G__17048 = (i_17047 + (1));
i_17047 = G__17048;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__5809__auto___17049 = a.length;
var i_17050 = (0);
while(true){
if((i_17050 < n__5809__auto___17049)){
var val_17051 = (a[i_17050]);
if((cljs.core.vector_QMARK_.call(null,val_17051)) && ((reagent.impl.template.key_from_vec.call(null,val_17051) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17050] = reagent.impl.template.as_element.call(null,val_17051));

var G__17052 = (i_17050 + (1));
i_17050 = G__17052;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4894__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4894__auto__){
return (ctx["no-key"]);
} else {
return and__4894__auto__;
...
var G__17054 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17054) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__17054){
