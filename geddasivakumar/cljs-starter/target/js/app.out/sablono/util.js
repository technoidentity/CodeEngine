...
var x__5561__auto__ = (((x == null))?null:x);
var m__5562__auto__ = (sablono.util.to_str[goog.typeOf(x__5561__auto__)]);
if(!((m__5562__auto__ == null))){
return m__5562__auto__.call(null,x);
} else {
var m__5562__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__5562__auto____$1 == null))){
return m__5562__auto____$1.call(null,x);
} else {
...
var x__5561__auto__ = (((x == null))?null:x);
var m__5562__auto__ = (sablono.util.to_uri[goog.typeOf(x__5561__auto__)]);
if(!((m__5562__auto__ == null))){
return m__5562__auto__.call(null,x);
} else {
var m__5562__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__5562__auto____$1 == null))){
return m__5562__auto____$1.call(null,x);
} else {
...
var len__5964__auto___15687 = arguments.length;
var i__5965__auto___15688 = (0);
while(true){
if((i__5965__auto___15688 < len__5964__auto___15687)){
args__5971__auto__.push((arguments[i__5965__auto___15688]));

var G__15689 = (i__5965__auto___15688 + (1));
i__5965__auto___15688 = G__15689;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__5972__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq15686){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15686));
});
/**
...
var vec__15691 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__15691,(0),null);
var words = cljs.core.nthnext.call(null,vec__15691,(1));
...
var G__15693 = clojure.set.rename_keys.call(null,m,kmap);
var G__15693__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__15693,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__15693);
return G__15693__$1;
} else {
return m;
}
...
var args__5971__auto__ = [];
var len__5964__auto___15696 = arguments.length;
var i__5965__auto___15697 = (0);
while(true){
if((i__5965__auto___15697 < len__5964__auto___15696)){
args__5971__auto__.push((arguments[i__5965__auto___15697]));

var G__15698 = (i__5965__auto___15697 + (1));
i__5965__auto___15697 = G__15698;
continue;
} else {
}
break;
...
var argseq__5972__auto__ = ((((0) < args__5971__auto__.length))?(new cljs.core.IndexedSeq(args__5971__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__5972__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15694_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__15694_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15694_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__15694_SHARP_)){
return p1__15694_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15694_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq15695){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15695));
});
/**
...
var vec__15702 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__15702,(0),null);
var names = cljs.core.nth.call(null,vec__15702,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__15702,tag_name,names){
return (function (p1__15699_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__15699_SHARP_));
});})(matches,vec__15702,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__15702,tag_name,names){
return (function (p1__15700_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__15700_SHARP_));
});})(matches,vec__15702,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__15703){
var vec__15706 = p__15703;
var tag = cljs.core.nth.call(null,vec__15706,(0),null);
var content = cljs.core.nthnext.call(null,vec__15706,(1));
...
var vec__15707 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__15707,(0),null);
var id = cljs.core.nth.call(null,vec__15707,(1),null);
var class$ = cljs.core.nth.call(null,vec__15707,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4906__auto__ = x__$1.hasDomain();
