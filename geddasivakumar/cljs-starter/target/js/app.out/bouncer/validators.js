...
bouncer.validators.in_range = cljs.core.with_meta.call(null,(function bouncer$validators$in_range(value,p__21267){
var vec__21269 = p__21267;
var from = cljs.core.nth.call(null,vec__21269,(0),null);
var to = cljs.core.nth.call(null,vec__21269,(1),null);
...
var and__4894__auto__ = bouncer.validators.required.call(null,value);
...
var bouncer$validators$datetime__delegate = function (value,p__21270){
var vec__21273 = p__21270;
var opt = cljs.core.nth.call(null,vec__21273,(0),null);
var _ = cljs.core.nthnext.call(null,vec__21273,(1));
...
}catch (e21274){if((e21274 instanceof Error)){
var e = e21274;
return false;
} else {
throw e21274;
...
var G__21275__i = 0, G__21275__a = new Array(arguments.length -  1);
while (G__21275__i < G__21275__a.length) {G__21275__a[G__21275__i] = arguments[G__21275__i + 1]; ++G__21275__i;}
  p__21270 = new cljs.core.IndexedSeq(G__21275__a,0);
} 
return bouncer$validators$datetime__delegate.call(this,value,p__21270);};
bouncer$validators$datetime.cljs$lang$maxFixedArity = 1;
bouncer$validators$datetime.cljs$lang$applyTo = (function (arglist__21276){
var value = cljs.core.first(arglist__21276);
var p__21270 = cljs.core.rest(arglist__21276);
return bouncer$validators$datetime__delegate(value,p__21270);
});
