...
var reader = (function (){var or__4906__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4906__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4906__auto__)){
return or__4906__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__15260__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15260__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15260__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__4425__auto___15262 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4425__auto___15262)){
var sense_15263 = temp__4425__auto___15262;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_15263)].join('');
} else {
}
}
} else {
